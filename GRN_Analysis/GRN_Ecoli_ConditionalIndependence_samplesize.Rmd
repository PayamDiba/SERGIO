...
dot <- read.dot("../GNW_sampled_GRNs/Ecoli_100_net1.dot") # GRN graph
GRN <- read.table("../data_sets/De-noised_100G_9T_300cPerT_4_DS1/Interaction_cID_4.txt", quote="\"", comment.char="")

# Load simulated gene expressions
  GRN_out <- read.csv("../data_sets/De-noised_100G_9T_300cPerT_4_DS1/simulated_noNoise_0.csv") # Existing data

# Load gene IDs
GeneIDs <- read.delim("../GNW_sampled_GRNs/Ecoli_100_net1.dot", header=FALSE)
