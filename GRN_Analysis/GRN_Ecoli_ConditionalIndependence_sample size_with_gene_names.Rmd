...
# GRN_out <- read.csv("../Demo/GeneExpression_SingleCell.csv") # Simulated single cell data
GRN_out <- read.csv("../data_sets/De-noised_100G_3T_300cPerT_dynamics_8_DS8/simulated_noNoise_S_0.csv") # Existing data
GeneIDs <- read.delim("../GRN_Analysis/GeneIDs.txt", header=FALSE) # Gene IDs
